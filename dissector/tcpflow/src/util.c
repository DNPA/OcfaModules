 ...
 * LICENSE for details.
 *
 * $Id: util.c,v 1.2 2009/03/31 09:04:17 rob Exp $
 *
 * $Log: util.c,v $
...
static char *cvsid = "$Id: util.c,v 1.2 2009/03/31 09:04:17 rob Exp $";

#include "tcpflow.h"
#include <boost/lexical_cast.hpp>
static std::string debug_prefix = "";
...
{
  debug_prefix=argv[0] + "[" + boost::lexical_cast<std::string>(getpid()) + "]";
}
...
{
  /* print debug prefix */
  fprintf(stderr, "%s: ", debug_prefix.c_str());
